 ...
 *
 * CorsMiddleware — handles CORS preflight and adds CORS headers.
 * Debug mode allows all origins; production uses whitelist.
 */
...
class CorsMiddleware implements MiddlewareInterface
{
    ...
    private function getAllowedOrigins(): array
    {
        ...
        if ($origins === '') {
            $origins = env('APP_URL', 'http://127.0.0.1:8789');
        }
