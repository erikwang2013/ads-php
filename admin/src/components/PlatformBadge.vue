<template>
  <span class="platform-badge" :style="{ background: bg, color: color }">{{ name }}</span>
</template>
...
<style scoped>
.platform-badge { display: inline-block; padding: 2px 8px; border-radius: 4px; font-size: 12px; font-weight: 500; }
</style>
