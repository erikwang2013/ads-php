# Fase 1: Plan de Implementación — Esqueleto Base
...
> **Para agentes trabajadores:** SUB-HABILIDAD REQUERIDA: usar superpowers:subagent-driven-development (recomendado) o superpowers:executing-plans para implementar este plan tarea por tarea. Los pasos usan sintaxis de casilla de verificación (`- [ ]`) para el seguimiento.

**Objetivo:** Construir el esqueleto del servidor webman v2 + el panel de administración webman-admin v2, implementando multitenencia, autenticación de permisos, gestión de cuentas, el marco del flujo OAuth, y completar el flujo completo con Ocean Engine como primera plataforma.

**Arquitectura:** Arquitectura de plugins de webman v2; bajo service/plugin/ se dividen los cuatro plugins ads-tenant, ads-account, ads-platform y ads-api según sus responsabilidades; el panel de administración usa Vue3+TS+Element Plus, gestiona el estado con Pinia y conecta con las APIs del backend mediante Axios.
...
### Tarea 1: Inicializar el proyecto de servidor webman v2
...
- Crear: `service/config/redis.php`
- Crear: `service/config/middleware.php`
- Crear: `service/support/Response.php`
- Crear: `service/start.php`

- [x] **Paso 1: Crear composer.json e instalar dependencias**
...
- [x] **Paso 2: Crear la configuración de entorno .env**
...
- [x] **Paso 4: Crear config/database.php con soporte de fuentes de datos dinámicas**
...
- [x] **Paso 5: Crear config/redis.php**
...
- [x] **Paso 6: Crear config/middleware.php**
...
- [x] **Paso 7: Crear support/Response.php con respuesta unificada**
...
- [x] **Paso 8: Crear service/start.php**
...
- [x] **Paso 9: Verificar el arranque del proyecto**

Run: `cd service && php start.php start`
Esperado: webman v2 arranca correctamente, escuchando en el puerto 8787
...
### Tarea 2: Crear el plugin multitenant ads-tenant

**Archivos:**
- Crear: `service/plugin/ads-tenant/config/plugin.php`
- Crear: `service/plugin/ads-tenant/config/database.php`
- Crear: `service/plugin/ads-tenant/model/Tenant.php`
- Crear: `service/plugin/ads-tenant/middleware/TenantIdentify.php`
- Crear: `service/plugin/ads-tenant/migration/create_tenants.sql`

- [x] **Paso 1: Crear plugin.php**
...
- [x] **Paso 2: Crear database.php con enrutamiento de fuentes de datos**
...
- [x] **Paso 3: Crear el modelo Tenant**
...
- [x] **Paso 4: Crear el middleware TenantIdentify**
...
- [x] **Paso 5: Crear el SQL de migración**
...
### Tarea 3: Crear el núcleo de adaptadores ads-platform

**Archivos:**
- Crear: `service/plugin/ads-platform/config/plugin.php`
- Crear: `service/plugin/ads-platform/src/PlatformAdapter.php`
- Crear: `service/plugin/ads-platform/src/AdapterRegistry.php`
- Crear: `service/plugin/ads-platform/src/FieldMapping.php`
- Crear: `service/plugin/ads-platform/src/CampaignData.php`
- Crear: `service/plugin/ads-platform/src/ReportRequest.php`
- Crear: `service/plugin/ads-platform/adapter/Juliang.php`

- [x] **Paso 1: Crear la interfaz PlatformAdapter**
...
- [x] **Paso 4: Crear el motor de mapeo de campos FieldMapping**
...
- [x] **Paso 5: Crear AdapterRegistry**
...
- [x] **Paso 6: Crear el adaptador de Ocean Engine (mapeo de campos + esqueleto de interfaz)**
...
- [x] **Paso 8: Crear el SQL de migración (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Paso 9: Registrar el adaptador de Ocean Engine en AdapterRegistry**

Crear `service/plugin/ads-platform/config/bootstrap.php`:
...
### Tarea 4: Crear el plugin de gestión de cuentas ads-account

**Archivos:**
- Crear: `service/plugin/ads-account/config/plugin.php`
- Crear: `service/plugin/ads-account/model/PlatformAccount.php`
- Crear: `service/plugin/ads-account/model/AuthToken.php`
- Crear: `service/plugin/ads-account/service/OAuthService.php`
- Crear: `service/plugin/ads-account/migration/create_platform_accounts.sql`
...
- [x] **Paso 2: Crear el modelo PlatformAccount**
...
- [x] **Paso 3: Crear el modelo AuthToken (para el almacenamiento de state en el flujo OAuth)**
...
### Tarea 5: Crear el plugin ads-api (API RESTful + autenticación JWT)

**Archivos:**
- Crear: `service/plugin/ads-api/config/plugin.php`
- Crear: `service/plugin/ads-api/config/route.php`
- Crear: `service/plugin/ads-api/middleware/AuthMiddleware.php`
- Crear: `service/plugin/ads-api/controller/AuthController.php`
- Crear: `service/plugin/ads-api/controller/PlatformController.php`
- Crear: `service/plugin/ads-api/controller/AccountController.php`
- Crear: `service/plugin/ads-api/controller/CampaignController.php`
- Crear: `service/plugin/ads-api/controller/DashboardController.php`
...
- [x] **Paso 2: Crear el AuthMiddleware JWT**
...
- [x] **Paso 4: Crear PlatformController**
...
- [x] **Paso 5: Crear AccountController**
...
- [x] **Paso 6: Crear CampaignController**
...
- [x] **Paso 7: Crear DashboardController**
...
- [x] **Paso 8: Crear la configuración de rutas route.php**
...
### Tarea 6: Inicializar el proyecto de panel de administración webman-admin v2

**Archivos:**
- Crear: `admin/package.json`
- Crear: `admin/vite.config.ts`
- Crear: `admin/tsconfig.json`
- Crear: `admin/index.html`
- Crear: `admin/src/main.ts`
- Crear: `admin/src/App.vue`
- Crear: `admin/src/router/index.ts`
- Crear: `admin/src/api/index.ts`

- [x] **Paso 1: Crear package.json**
...
- [x] **Paso 7: Crear src/router/index.ts**
...
- [x] **Paso 8: Crear src/api/index.ts (encapsulación Axios)**
...
- [x] **Paso 9: Instalar dependencias y verificar**

Run: `cd admin && npm install && npm run dev`
Esperado: el servidor de desarrollo de Vite arranca en el puerto 5173
...
### Tarea 7: Diseño del panel de administración y página de login

**Archivos:**
- Crear: `admin/src/components/layout/AppLayout.vue`
- Crear: `admin/src/components/layout/SideNav.vue`
- Crear: `admin/src/components/layout/TopBar.vue`
- Crear: `admin/src/views/login/LoginPage.vue`
- Crear: `admin/src/stores/auth.ts`
- Crear: `admin/src/api/auth.ts`

- [x] **Paso 1: Crear el store auth**
...
### Tarea 8: Páginas principales del panel de administración

**Archivos:**
- Crear: `admin/src/views/dashboard/DashboardPage.vue`
- Crear: `admin/src/views/account/AccountList.vue`
- Crear: `admin/src/views/account/AccountBind.vue`
- Crear: `admin/src/views/campaign/CampaignList.vue`
- Crear: `admin/src/components/MetricCard.vue`
- Crear: `admin/src/components/PlatformBadge.vue`
- Crear: `admin/src/api/dashboard.ts`
- Crear: `admin/src/api/account.ts`
- Crear: `admin/src/api/campaign.ts`
- Crear: `admin/src/utils/format.ts`

- [x] **Paso 1: Crear las funciones de utilidad format.ts**
...
- [x] **Paso 3: Crear PlatformBadge.vue**
...
- [x] **Paso 4: Crear DashboardPage.vue**
...
- [x] **Paso 5: Crear AccountList.vue**
...
- [x] **Paso 6: Crear AccountBind.vue**
...
- [x] **Paso 7: Crear CampaignList.vue**
...
- [x] **Paso 8: Crear los archivos de encapsulación de API**
...
- [x] **Paso 9: Verificar las funciones del panel de administración**

Run: `cd admin && npm run dev`
Config: asegurar que el proxy de vite apunta al servidor webman en el puerto 8787
Check: login → dashboard → gestión de cuentas → crear plan → activar/pausar plan
...
### Tarea 9: Guía de configuración y verificación de arranque del proyecto

**Archivos:**
- Crear: `service/start.php` (modificar si existe)
- Crear: `README.md`

- [x] **Paso 1: Añadir la carga de plugins y la inicialización de la base de datos en service/start.php**
...
- [x] **Paso 2: Ejecutar las migraciones de la base de datos**
...
- [x] **Paso 3: Arrancar el servidor y verificar la API**
...
```
Esperado: `{"code":0,"data":{"access_token":"...","user":{...}}}`

Test platforms:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
Esperado: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Paso 4: Arrancar el panel de administración y verificar la integración**
...
3. Ver el dashboard (sin datos)
4. Ir a gestión de cuentas → vincular cuenta (requiere AppId formal de Ocean Engine)
5. Crear un plan publicitario de prueba

- [x] **Paso 5: Commit del estado final**
...
Tras completar la Fase 1, se debe alcanzar el siguiente estado:

1. ✅ El servidor webman v2 puede arrancar; las conexiones MySQL y Redis son correctas
2. ✅ La tabla multitenant `tenants` está creada; el middleware TenantIdentify funciona
3. ✅ La interfaz de adaptadores de plataforma `PlatformAdapter` está completamente definida; el adaptador de Ocean Engine implementa todos los métodos
4. ✅ El flujo de autorización OAuth está completo: obtener URL de autorización → manejar callback → almacenar Token → vincular cuenta
5. ✅ Las tablas unificadas de campañas `campaigns/ad_groups/creatives` y las tablas de informes `report_metrics/report_extras` están creadas
6. ✅ La API RESTful es accesible con autenticación: `POST /auth/login` → obtener Token → llamar a otras interfaces
7. ✅ El panel de administración permite iniciar sesión; las páginas de dashboard/gestión de cuentas/gestión de planes funcionan
8. ✅ El panel de administración puede crear planes publicitarios y sincronizarlos con la plataforma Ocean Engine
