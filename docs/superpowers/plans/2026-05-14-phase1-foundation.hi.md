# Phase 1: 基础骨架 कार्यान्वयन योजना
...
**लक्ष्य:** webman v2 सर्वर + webman-admin v2 प्रबंधन बैकएंड का आधार ढांचा तैयार करें, मल्टी-टेनेंट, प्रमाणीकरण-अनुमति, खाता प्रबंधन, OAuth प्रवाह ढांचा लागू करें, और जुलियांग इंजन को पहले प्लेटफ़ॉर्म के रूप में उपयोग करके पूरी श्रृंखला चलाएँ।

**आर्किटेक्चर:** webman v2 प्लगइन-आधारित आर्किटेक्चर, service/plugin/ के अंतर्गत ज़िम्मेदारी के अनुसार ads-tenant, ads-account, ads-platform, ads-api चार प्लगइन विभाजित हैं; प्रबंधन बैकएंड Vue3+TS+Element Plus का उपयोग करता है, स्टेट को Pinia से प्रबंधित करता है, Axios से बैकएंड API से जुड़ता है।

**तकनीकी स्टैक:** PHP 8.2+, webman v2, MySQL 8.0, Redis 7, Vue 3, TypeScript, Element Plus, ECharts 5, Pinia, Axios
...
### Task 1: webman v2 सर्वर प्रोजेक्ट इनिशियलाइज़ करें
...
- [x] **Step 1: composer.json बनाएँ और डिपेंडेंसी इंस्टॉल करें**
...
चलाएँ: `cd service && composer install`

- [x] **Step 2: .env पर्यावरण कॉन्फ़िगरेशन बनाएँ**
...
- [x] **Step 4: config/database.php बनाएँ जो डायनामिक डेटा स्रोत का समर्थन करता है**
...
- [x] **Step 5: config/redis.php बनाएँ**
...
- [x] **Step 6: config/middleware.php बनाएँ**
...
- [x] **Step 7: support/Response.php एकीकृत प्रतिक्रिया बनाएँ**
...
- [x] **Step 8: service/start.php बनाएँ**
...
- [x] **Step 9: प्रोजेक्ट स्टार्टअप सत्यापित करें**

चलाएँ: `cd service && php start.php start`
अपेक्षा: webman v2 सफलतापूर्वक स्टार्ट हो, 8787 पोर्ट पर सुनता हो
...
### Task 2: ads-tenant मल्टी-टेनेंट प्लगइन बनाएँ
...
- [x] **Step 2: database.php डेटा स्रोत रूटिंग बनाएँ**
...
- [x] **Step 4: TenantIdentify मिडलवेयर बनाएँ**
...
### Task 3: ads-platform एडाप्टर कोर बनाएँ
...
- [x] **Step 1: PlatformAdapter इंटरफ़ेस बनाएँ**
...
- [x] **Step 4: FieldMapping फ़ील्ड मैपिंग इंजन बनाएँ**
...
- [x] **Step 5: AdapterRegistry बनाएँ**
...
- [x] **Step 6: जुलियांग इंजन एडाप्टर बनाएँ (फ़ील्ड मैपिंग + इंटरफ़ेस स्केलेटन)**
...
- [x] **Step 8: माइग्रेशन SQL बनाएँ (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Step 9: जुलियांग इंजन एडाप्टर को AdapterRegistry में पंजीकृत करें**

`service/plugin/ads-platform/config/bootstrap.php` बनाएँ:
...
### Task 4: ads-account खाता प्रबंधन प्लगइन बनाएँ
...
- [x] **Step 2: PlatformAccount मॉडल बनाएँ**
...
- [x] **Step 3: AuthToken मॉडल बनाएँ (OAuth प्रवाह में state संग्रहण के लिए)**
...
### Task 5: ads-api प्लगइन बनाएँ (RESTful API + JWT प्रमाणीकरण)
...
- [x] **Step 2: JWT AuthMiddleware बनाएँ**
...
- [x] **Step 4: PlatformController बनाएँ**
...
- [x] **Step 5: AccountController बनाएँ**
...
- [x] **Step 6: CampaignController बनाएँ**
...
- [x] **Step 7: DashboardController बनाएँ**
...
- [x] **Step 8: रूट कॉन्फ़िगरेशन route.php बनाएँ**
...
### Task 6: webman-admin v2 प्रबंधन बैकएंड प्रोजेक्ट इनिशियलाइज़ करें
...
- [x] **Step 7: src/router/index.ts बनाएँ**
...
- [x] **Step 8: src/api/index.ts बनाएँ (Axios रैपर)**
...
- [x] **Step 9: डिपेंडेंसी इंस्टॉल करें और सत्यापित करें**

चलाएँ: `cd admin && npm install && npm run dev`
अपेक्षा: Vite डेवलपमेंट सर्वर 5173 पोर्ट पर स्टार्ट हो
...
### Task 7: प्रबंधन बैकएंड लेआउट और लॉगिन पेज
...
- [x] **Step 1: उपयोगिता फ़ंक्शन format.ts बनाएँ**
...
- [x] **Step 3: PlatformBadge.vue बनाएँ**
...
- [x] **Step 4: DashboardPage.vue बनाएँ**
...
- [x] **Step 5: AccountList.vue बनाएँ**
...
- [x] **Step 6: AccountBind.vue बनाएँ**
...
- [x] **Step 7: CampaignList.vue बनाएँ**
...
- [x] **Step 8: API रैपर फ़ाइलें बनाएँ**
...
- [x] **Step 9: प्रबंधन बैकएंड कार्यक्षमता सत्यापित करें**

चलाएँ: `cd admin && npm run dev`
कॉन्फ़िग: सुनिश्चित करें कि vite proxy webman सर्वर के 8787 पोर्ट की ओर इंगित करता है
जाँच: लॉगिन → डैशबोर्ड → खाता प्रबंधन → प्लान बनाएँ → प्लान चालू/बंद करें
...
### Task 9: कॉन्फ़िगरेशन गाइड और प्रोजेक्ट स्टार्टअप सत्यापन

**फ़ाइलें:**
- Create: `service/start.php` (यदि मौजूद है तो संशोधित करें)
- Create: `README.md`

- [x] **Step 1: service/start.php में प्लगइन लोडिंग और डेटाबेस इनिशियलाइज़ेशन जोड़ें**
...
- [x] **Step 2: डेटाबेस माइग्रेशन चलाएँ**
...
- [x] **Step 3: सर्वर स्टार्ट करें और API सत्यापित करें**

चलाएँ: `cd service && php start.php start -d`
...
```
अपेक्षा: `{"code":0,"data":{"access_token":"...","user":{...}}}`

प्लेटफ़ॉर्म टेस्ट:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
अपेक्षा: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Step 4: प्रबंधन बैकएंड स्टार्ट करें और लिंकिंग सत्यापित करें**

चलाएँ: `cd admin && npm run dev`

टेस्ट प्रवाह:
1. ब्राउज़र में `http://localhost:5173` खोलें
2. `admin / admin123` से लॉगिन करें
3. डैशबोर्ड देखें (खाली डेटा)
4. खाता प्रबंधन में जाएँ → खाता बाँधें (जुलियांग इंजन का आधिकारिक AppId चाहिए)
5. टेस्ट एडवरटाइज़िंग प्लान बनाएँ

- [x] **Step 5: अंतिम स्थिति कमिट करें**
...
Phase 1 पूरा होने पर निम्नलिखित स्थिति प्राप्त होनी चाहिए:

1. ✅ webman v2 सर्वर स्टार्ट हो सकता है, MySQL, Redis कनेक्शन सामान्य हैं
2. ✅ मल्टी-टेनेंट तालिका `tenants` बन चुकी है, TenantIdentify मिडलवेयर उपलब्ध है
3. ✅ प्लेटफ़ॉर्म एडाप्टर इंटरफ़ेस `PlatformAdapter` पूर्ण रूप से परिभाषित है, जुलियांग इंजन एडाप्टर सभी विधियाँ लागू करता है
4. ✅ OAuth प्राधिकरण प्रवाह पूर्ण: प्राधिकरण URL प्राप्त करें → कॉलबैक प्रोसेसिंग → Token संग्रहण → खाता बंधन
5. ✅ एकीकृत डिलीवरी तालिकाएँ `campaigns/ad_groups/creatives` और रिपोर्ट तालिकाएँ `report_metrics/report_extras` बन चुकी हैं
6. ✅ RESTful API प्रमाणीकरण के साथ एक्सेस हो सकती है: `POST /auth/login` → Token प्राप्त करें → अन्य इंटरफ़ेस कॉल करें
7. ✅ प्रबंधन बैकएंड में लॉगिन हो सकता है, डैशबोर्ड/खाता प्रबंधन/प्लान प्रबंधन पेज उपलब्ध हैं
8. ✅ प्रबंधन बैकएंड एडवरटाइज़िंग प्लान बना सकता है और जुलियांग इंजन प्लेटफ़ॉर्म पर सिंक कर सकता है
