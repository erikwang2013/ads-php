# Phase 1: Implementierungsplan Grundgerüst
...
**Ziel:** Das Grundgerüst aus webman-v2-Server + webman-admin-v2-Verwaltungs-Backend aufbauen, Multi-Tenant, Authentifizierung und Berechtigungen, Kontoverwaltung und den OAuth-Ablaufrahmen implementieren und mit 巨量引擎 als erster Plattform die gesamte Kette durchlaufen.

**Architektur:** webman-v2-Plugin-Architektur; unter service/plugin/ werden nach Verantwortlichkeiten die vier Plugins ads-tenant, ads-account, ads-platform und ads-api aufgeteilt; das Verwaltungs-Backend nutzt Vue3+TS+Element Plus, verwaltet den Zustand über Pinia und verbindet sich über Axios mit der Backend-API.
...
### Task 1: webman-v2-Serverprojekt initialisieren

**Dateien:**
- Erstellen: `service/composer.json`
- Erstellen: `service/.env`
- Erstellen: `service/config/app.php`
- Erstellen: `service/config/database.php`
- Erstellen: `service/config/redis.php`
- Erstellen: `service/config/middleware.php`
- Erstellen: `service/support/Response.php`
- Erstellen: `service/start.php`

- [x] **Schritt 1: composer.json erstellen und Abhängigkeiten installieren**
...
- [x] **Schritt 2: .env-Umgebungskonfiguration erstellen**
...
- [x] **Schritt 3: config/app.php erstellen**
...
- [x] **Schritt 4: config/database.php mit dynamischer Datenquelle erstellen**
...
- [x] **Schritt 5: config/redis.php erstellen**
...
- [x] **Schritt 6: config/middleware.php erstellen**
...
- [x] **Schritt 7: support/Response.php mit einheitlicher Antwort erstellen**
...
- [x] **Schritt 8: service/start.php erstellen**
...
- [x] **Schritt 9: Projektstart verifizieren**

Ausführen: `cd service && php start.php start`
Erwartung: webman v2 startet erfolgreich und lauscht auf Port 8787
...
### Task 2: ads-tenant-Multi-Tenant-Plugin erstellen

**Dateien:**
- Erstellen: `service/plugin/ads-tenant/config/plugin.php`
- Erstellen: `service/plugin/ads-tenant/config/database.php`
- Erstellen: `service/plugin/ads-tenant/model/Tenant.php`
- Erstellen: `service/plugin/ads-tenant/middleware/TenantIdentify.php`
- Erstellen: `service/plugin/ads-tenant/migration/create_tenants.sql`

- [x] **Schritt 1: plugin.php erstellen**
...
- [x] **Schritt 2: database.php-Datenquellen-Routing erstellen**
...
- [x] **Schritt 3: Tenant-Modell erstellen**
...
- [x] **Schritt 4: TenantIdentify-Middleware erstellen**
...
- [x] **Schritt 5: Migrations-SQL erstellen**
...
### Task 3: ads-platform-Adapterkern erstellen

**Dateien:**
- Erstellen: `service/plugin/ads-platform/config/plugin.php`
- Erstellen: `service/plugin/ads-platform/src/PlatformAdapter.php`
- Erstellen: `service/plugin/ads-platform/src/AdapterRegistry.php`
- Erstellen: `service/plugin/ads-platform/src/FieldMapping.php`
- Erstellen: `service/plugin/ads-platform/src/CampaignData.php`
- Erstellen: `service/plugin/ads-platform/src/ReportRequest.php`
- Erstellen: `service/plugin/ads-platform/adapter/Juliang.php`

- [x] **Schritt 1: PlatformAdapter-Schnittstelle erstellen**
...
- [x] **Schritt 2: CampaignData erstellen**
...
- [x] **Schritt 3: ReportRequest erstellen**
...
- [x] **Schritt 4: FieldMapping-Feldzuordnungs-Engine erstellen**
...
- [x] **Schritt 5: AdapterRegistry erstellen**
...
- [x] **Schritt 6: 巨量引擎-Adapter erstellen (Feldzuordnung + Schnittstellengerüst)**
...
- [x] **Schritt 7: plugin.php erstellen**
...
- [x] **Schritt 8: Migrations-SQL erstellen (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Schritt 9: 巨量引擎-Adapter in AdapterRegistry registrieren**

`service/plugin/ads-platform/config/bootstrap.php` erstellen:
...
### Task 4: ads-account-Kontoverwaltungs-Plugin erstellen

**Dateien:**
- Erstellen: `service/plugin/ads-account/config/plugin.php`
- Erstellen: `service/plugin/ads-account/model/PlatformAccount.php`
- Erstellen: `service/plugin/ads-account/model/AuthToken.php`
- Erstellen: `service/plugin/ads-account/service/OAuthService.php`
- Erstellen: `service/plugin/ads-account/migration/create_platform_accounts.sql`
...
- [x] **Schritt 2: PlatformAccount-Modell erstellen**
...
- [x] **Schritt 3: AuthToken-Modell erstellen (für die state-Speicherung im OAuth-Ablauf)**
...
- [x] **Schritt 4: OAuthService erstellen**
...
### Task 5: ads-api-Plugin erstellen (RESTful-API + JWT-Authentifizierung)

**Dateien:**
- Erstellen: `service/plugin/ads-api/config/plugin.php`
- Erstellen: `service/plugin/ads-api/config/route.php`
- Erstellen: `service/plugin/ads-api/middleware/AuthMiddleware.php`
- Erstellen: `service/plugin/ads-api/controller/AuthController.php`
- Erstellen: `service/plugin/ads-api/controller/PlatformController.php`
- Erstellen: `service/plugin/ads-api/controller/AccountController.php`
- Erstellen: `service/plugin/ads-api/controller/CampaignController.php`
- Erstellen: `service/plugin/ads-api/controller/DashboardController.php`
...
- [x] **Schritt 2: JWT-AuthMiddleware erstellen**
...
- [x] **Schritt 3: AuthController erstellen**
...
- [x] **Schritt 4: PlatformController erstellen**
...
- [x] **Schritt 5: AccountController erstellen**
...
- [x] **Schritt 6: CampaignController erstellen**
...
- [x] **Schritt 7: DashboardController erstellen**
...
- [x] **Schritt 8: Routenkonfiguration route.php erstellen**
...
### Task 6: webman-admin-v2-Verwaltungs-Backend-Projekt initialisieren

**Dateien:**
- Erstellen: `admin/package.json`
- Erstellen: `admin/vite.config.ts`
- Erstellen: `admin/tsconfig.json`
- Erstellen: `admin/index.html`
- Erstellen: `admin/src/main.ts`
- Erstellen: `admin/src/App.vue`
- Erstellen: `admin/src/router/index.ts`
- Erstellen: `admin/src/api/index.ts`

- [x] **Schritt 1: package.json erstellen**
...
- [x] **Schritt 2: vite.config.ts erstellen**
...
- [x] **Schritt 3: tsconfig.json erstellen**
...
- [x] **Schritt 4: index.html erstellen**
...
- [x] **Schritt 5: src/main.ts erstellen**
...
- [x] **Schritt 6: src/App.vue erstellen**
...
- [x] **Schritt 7: src/router/index.ts erstellen**
...
- [x] **Schritt 8: src/api/index.ts erstellen (Axios-Kapselung)**
...
- [x] **Schritt 9: Abhängigkeiten installieren und verifizieren**

Ausführen: `cd admin && npm install && npm run dev`
Erwartung: Vite-Entwicklungsserver startet auf Port 5173
...
### Task 7: Verwaltungs-Backend-Layout & Login-Seite

**Dateien:**
- Erstellen: `admin/src/components/layout/AppLayout.vue`
- Erstellen: `admin/src/components/layout/SideNav.vue`
- Erstellen: `admin/src/components/layout/TopBar.vue`
- Erstellen: `admin/src/views/login/LoginPage.vue`
- Erstellen: `admin/src/stores/auth.ts`
- Erstellen: `admin/src/api/auth.ts`

- [x] **Schritt 1: auth-Store erstellen**
...
- [x] **Schritt 2: auth-API erstellen**
...
- [x] **Schritt 3: LoginPage.vue erstellen**
...
- [x] **Schritt 4: SideNav.vue erstellen**
...
- [x] **Schritt 5: TopBar.vue erstellen**
...
- [x] **Schritt 6: AppLayout.vue erstellen**
...
### Task 8: Kernseiten des Verwaltungs-Backends

**Dateien:**
- Erstellen: `admin/src/views/dashboard/DashboardPage.vue`
- Erstellen: `admin/src/views/account/AccountList.vue`
- Erstellen: `admin/src/views/account/AccountBind.vue`
- Erstellen: `admin/src/views/campaign/CampaignList.vue`
- Erstellen: `admin/src/components/MetricCard.vue`
- Erstellen: `admin/src/components/PlatformBadge.vue`
- Erstellen: `admin/src/api/dashboard.ts`
- Erstellen: `admin/src/api/account.ts`
- Erstellen: `admin/src/api/campaign.ts`
- Erstellen: `admin/src/utils/format.ts`

- [x] **Schritt 1: Hilfsfunktionen format.ts erstellen**
...
- [x] **Schritt 2: MetricCard.vue erstellen**
...
- [x] **Schritt 3: PlatformBadge.vue erstellen**
...
- [x] **Schritt 4: DashboardPage.vue erstellen**
...
- [x] **Schritt 5: AccountList.vue erstellen**
...
- [x] **Schritt 6: AccountBind.vue erstellen**
...
- [x] **Schritt 7: CampaignList.vue erstellen**
...
- [x] **Schritt 8: API-Kapselungsdateien erstellen**
...
- [x] **Schritt 9: Funktionen des Verwaltungs-Backends verifizieren**

Ausführen: `cd admin && npm run dev`
Konfiguration: Sicherstellen, dass der Vite-Proxy auf den webman-Server-Port 8787 zeigt
Prüfen: Login → Dashboard → Kontoverwaltung → Plan erstellen → Plan starten/stoppen
...
### Task 9: Konfigurationsanleitung & Projektstart-Verifizierung

**Dateien:**
- Erstellen: `service/start.php` (falls vorhanden, ändern)
- Erstellen: `README.md`

- [x] **Schritt 1: Plugin-Laden und Datenbank-Initialisierung in service/start.php hinzufügen**
...
- [x] **Schritt 2: Datenbank-Migrationen ausführen**
...
- [x] **Schritt 3: Server starten und API verifizieren**

Ausführen: `cd service && php start.php start -d`
...
```
Erwartung: `{"code":0,"data":{"access_token":"...","user":{...}}}`

Plattformen testen:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
Erwartung: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Schritt 4: Verwaltungs-Backend starten und Verbund-Test verifizieren**

Ausführen: `cd admin && npm run dev`

Testablauf:
1. Browser öffnet `http://localhost:5173`
2. Anmelden mit `admin / admin123`
3. Dashboard ansehen (leere Daten)
4. Kontoverwaltung → Konto binden (erfordert formelle 巨量引擎-AppId)
5. Test-Werbeplan erstellen

- [x] **Schritt 5: Endzustand committen**
...
Nach Abschluss von Phase 1 sollte der folgende Zustand erreicht sein:

1. ✅ Der webman-v2-Server lässt sich starten, MySQL- und Redis-Verbindungen sind normal
2. ✅ Die Multi-Tenant-Tabelle `tenants` ist angelegt, die TenantIdentify-Middleware ist nutzbar
3. ✅ Die Plattform-Adapter-Schnittstelle `PlatformAdapter` ist vollständig definiert, der 巨量引擎-Adapter implementiert alle Methoden
4. ✅ Der OAuth-Autorisierungsablauf ist vollständig: Autorisierungs-URL abrufen → Callback verarbeiten → Token speichern → Konto binden
5. ✅ Die einheitlichen Werbetabellen `campaigns/ad_groups/creatives` und die Berichtstabellen `report_metrics/report_extras` sind angelegt
6. ✅ Die RESTful-API ist authentifizierbar: `POST /auth/login` → Token erhalten → weitere Schnittstellen aufrufen
7. ✅ Das Verwaltungs-Backend kann sich anmelden, Dashboard-/Kontoverwaltungs-/Planverwaltungs-Seiten sind nutzbar
8. ✅ Das Verwaltungs-Backend kann Werbepläne erstellen und mit der 巨量引擎-Plattform synchronisieren
