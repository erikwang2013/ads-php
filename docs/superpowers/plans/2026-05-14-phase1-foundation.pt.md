# Phase 1: Plano de implementação do esqueleto base
...
**Objetivo:** montar o esqueleto do backend webman v2 + painel administrativo webman-admin v2, implementando multitenant, autenticação e permissões, gerenciamento de contas e o framework do fluxo OAuth, usando a Juliang (Ocean Engine) como primeira plataforma para percorrer todo o caminho.

**Arquitetura:** arquitetura de plugins do webman v2, dividindo em `service/plugin/` quatro plugins por responsabilidade: ads-tenant, ads-account, ads-platform e ads-api; o painel administrativo usa Vue3+TS+Element Plus, com Pinia para gerenciar estado e Axios para se conectar à API do backend.
...
### Task 1: inicializar o projeto de backend webman v2
...
- [x] **Step 1: criar composer.json e instalar as dependências**
...
- [x] **Step 2: criar a configuração de ambiente .env**
...
- [x] **Step 4: criar config/database.php com suporte a fontes de dados dinâmicas**
...
- [x] **Step 5: criar config/redis.php**
...
- [x] **Step 6: criar config/middleware.php**
...
- [x] **Step 7: criar support/Response.php com resposta unificada**
...
- [x] **Step 8: criar service/start.php**
...
- [x] **Step 9: validar a inicialização do projeto**

Run: `cd service && php start.php start`
Esperado: webman v2 iniciado com sucesso, escutando na porta 8787
...
### Task 2: criar o plugin multitenant ads-tenant
...
- [x] **Step 2: criar database.php com roteamento de fontes de dados**
...
- [x] **Step 3: criar o modelo Tenant**
...
- [x] **Step 4: criar o middleware TenantIdentify**
...
- [x] **Step 5: criar o SQL de migração**
...
### Task 3: criar o núcleo de adaptadores ads-platform
...
- [x] **Step 1: criar a interface PlatformAdapter**
...
- [x] **Step 4: criar o engine de mapeamento de campos FieldMapping**
...
- [x] **Step 5: criar AdapterRegistry**
...
- [x] **Step 6: criar o adaptador da Juliang (Ocean Engine) (mapeamento de campos + esqueleto da interface)**
...
- [x] **Step 8: criar o SQL de migração (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Step 9: registrar o adaptador da Juliang no AdapterRegistry**
...
### Task 4: criar o plugin de gerenciamento de contas ads-account
...
- [x] **Step 2: criar o modelo PlatformAccount**
...
- [x] **Step 3: criar o modelo AuthToken (para armazenamento do state no fluxo OAuth)**
...
### Task 5: criar o plugin ads-api (API RESTful + autenticação JWT)
...
- [x] **Step 2: criar o AuthMiddleware JWT**
...
- [x] **Step 4: criar PlatformController**
...
- [x] **Step 5: criar AccountController**
...
- [x] **Step 6: criar CampaignController**
...
- [x] **Step 7: criar DashboardController**
...
- [x] **Step 8: criar a configuração de rotas route.php**
...
### Task 6: inicializar o projeto do painel administrativo webman-admin v2
...
- [x] **Step 7: criar src/router/index.ts**
...
- [x] **Step 8: criar src/api/index.ts (encapsulamento Axios)**
...
- [x] **Step 9: instalar as dependências e validar**

Run: `cd admin && npm install && npm run dev`
Esperado: Vite dev server iniciado na porta 5173
...
### Task 7: layout do painel administrativo & página de login
...
### Task 8: páginas principais do painel administrativo
...
- [x] **Step 1: criar a função utilitária format.ts**
...
- [x] **Step 3: criar PlatformBadge.vue**
...
- [x] **Step 4: criar DashboardPage.vue**
...
- [x] **Step 5: criar AccountList.vue**
...
- [x] **Step 6: criar AccountBind.vue**
...
- [x] **Step 7: criar CampaignList.vue**
...
- [x] **Step 8: criar os arquivos de encapsulamento da API**
...
- [x] **Step 9: validar as funcionalidades do painel administrativo**

Run: `cd admin && npm run dev`
Config: garantir que o proxy do vite aponte para o backend webman na porta 8787
Check: login → dashboard → gerenciamento de contas → criar plano → iniciar/pausar plano
...
### Task 9: orientação de configuração & validação da inicialização do projeto

**Files:**
- Create: `service/start.php` (modificar se já existir)
- Create: `README.md`

- [x] **Step 1: adicionar o carregamento de plugins e a inicialização do banco de dados em service/start.php**
...
- [x] **Step 2: executar as migrações do banco de dados**
...
- [x] **Step 3: iniciar o backend e validar a API**
...
```
Esperado: `{"code":0,"data":[{"code":"juliang","name":"Juliang (Ocean Engine)","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Step 4: iniciar o painel administrativo e validar a integração**
...
3. Visualizar o dashboard (dados vazios)
4. Entrar em gerenciamento de contas → vincular conta (requer AppId oficial da Juliang)
5. Criar um plano de anúncios de teste

- [x] **Step 5: commitar o estado final**
...
Após a conclusão do Phase 1, o projeto deve atingir o seguinte estado:

1. ✅ O backend webman v2 inicia corretamente, com conexões MySQL e Redis funcionando
2. ✅ A tabela multitenant `tenants` criada e o middleware TenantIdentify funcional
3. ✅ A interface `PlatformAdapter` totalmente definida, com o adaptador da Juliang implementando todos os métodos
4. ✅ Fluxo de autorização OAuth completo: obter URL de autorização → processar callback → armazenar Token → vincular conta
5. ✅ Tabelas unificadas de veiculação `campaigns/ad_groups/creatives` e de relatórios `report_metrics/report_extras` criadas
6. ✅ A API RESTful acessível com autenticação: `POST /auth/login` → obter Token → chamar outras interfaces
7. ✅ O painel administrativo permite login, com as páginas de dashboard/gerenciamento de contas/gerenciamento de planos funcionais
8. ✅ O painel administrativo pode criar planos de anúncios e sincronizá-los com a plataforma Juliang
