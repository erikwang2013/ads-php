# المرحلة 1: خطة تنفيذ الهيكل الأساسي
...
**الهدف:** بناء هيكل خادم webman v2 + لوحة إدارة webman-admin v2، وتنفيذ تعدد المستأجرين والمصادقة والصلاحيات وإدارة الحسابات وإطار تدفق OAuth، مع تشغيل السلسلة الكاملة باستخدام Juliang كمحول المنصة الأول.

**البنية:** بنية إضافات webman v2، مقسمة في service/plugin/ حسب المسؤولية إلى أربع إضافات: ads-tenant وads-account وads-platform وads-api؛ تستخدم لوحة الإدارة Vue3+TS+Element Plus مع إدارة الحالة عبر Pinia، وربط واجهة API الخلفية عبر Axios.
...
### المهمة 1: تهيئة مشروع خادم webman v2
...
- [x] **الخطوة 1: إنشاء composer.json وتثبيت التبعيات**
...
التشغيل: `cd service && composer install`

- [x] **الخطوة 2: إنشاء تكوين البيئة .env**
...
- [x] **الخطوة 3: إنشاء config/app.php**
...
- [x] **الخطوة 4: إنشاء config/database.php بدعم مصادر البيانات الديناميكية**
...
- [x] **الخطوة 5: إنشاء config/redis.php**
...
- [x] **الخطوة 6: إنشاء config/middleware.php**
...
- [x] **الخطوة 7: إنشاء support/Response.php للاستجابات الموحدة**
...
- [x] **الخطوة 8: إنشاء service/start.php**
...
- [x] **الخطوة 9: التحقق من تشغيل المشروع**

التشغيل: `cd service && php start.php start`
المتوقع: تشغيل webman v2 بنجاح والاستماع على المنفذ 8787

- [x] **الخطوة 10: الالتزام**
...
### المهمة 2: إنشاء إضافة ads-tenant للمستأجرين المتعددين
...
- [x] **الخطوة 2: إنشاء database.php لتوجيه مصدر البيانات**
...
- [x] **الخطوة 4: إنشاء الوسيط TenantIdentify**
...
### المهمة 3: إنشاء نواة محولات ads-platform
...
- [x] **الخطوة 1: إنشاء واجهة PlatformAdapter**
...
- [x] **الخطوة 3: إنشاء ReportRequest**
...
- [x] **الخطوة 4: إنشاء محرك تعيين الحقول FieldMapping**
...
- [x] **الخطوة 5: إنشاء AdapterRegistry**
...
- [x] **الخطوة 6: إنشاء محول Juliang (تعيين الحقول + هيكل الواجهة)**
...
- [x] **الخطوة 8: إنشاء SQL الهجرة (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **الخطوة 9: تسجيل محول Juliang في AdapterRegistry**

أنشئ `service/plugin/ads-platform/config/bootstrap.php`:
...
### المهمة 4: إنشاء إضافة إدارة الحسابات ads-account
...
- [x] **الخطوة 2: إنشاء نموذج PlatformAccount**
...
- [x] **الخطوة 3: إنشاء نموذج AuthToken (لتخزين state في تدفق OAuth)**
...
### المهمة 5: إنشاء إضافة ads-api (RESTful API + مصادقة JWT)
...
- [x] **الخطوة 2: إنشاء AuthMiddleware الخاص بـ JWT**
...
- [x] **الخطوة 3: إنشاء AuthController**
...
- [x] **الخطوة 4: إنشاء PlatformController**
...
- [x] **الخطوة 5: إنشاء AccountController**
...
- [x] **الخطوة 6: إنشاء CampaignController**
...
- [x] **الخطوة 7: إنشاء DashboardController**
...
- [x] **الخطوة 8: إنشاء تكوين المسارات route.php**
...
### المهمة 6: تهيئة مشروع لوحة إدارة webman-admin v2
...
- [x] **الخطوة 2: إنشاء vite.config.ts**
...
- [x] **الخطوة 3: إنشاء tsconfig.json**
...
- [x] **الخطوة 7: إنشاء src/router/index.ts**
...
- [x] **الخطوة 8: إنشاء src/api/index.ts (تغليف Axios)**
...
- [x] **الخطوة 9: تثبيت التبعيات والتحقق**

التشغيل: `cd admin && npm install && npm run dev`
المتوقع: تشغيل خادم تطوير Vite على المنفذ 5173
...
### المهمة 7: تخطيط لوحة الإدارة وصفحة تسجيل الدخول
...
- [x] **الخطوة 3: إنشاء LoginPage.vue**
...
- [x] **الخطوة 6: إنشاء AppLayout.vue**
...
### المهمة 8: الصفحات الأساسية للوحة الإدارة
...
- [x] **الخطوة 1: إنشاء دوال الأدوات format.ts**
...
- [x] **الخطوة 2: إنشاء MetricCard.vue**
...
- [x] **الخطوة 3: إنشاء PlatformBadge.vue**
...
- [x] **الخطوة 4: إنشاء DashboardPage.vue**
...
- [x] **الخطوة 5: إنشاء AccountList.vue**
...
- [x] **الخطوة 6: إنشاء AccountBind.vue**
...
- [x] **الخطوة 7: إنشاء CampaignList.vue**
...
- [x] **الخطوة 8: إنشاء ملفات تغليف API**
...
- [x] **الخطوة 9: التحقق من وظائف لوحة الإدارة**

التشغيل: `cd admin && npm run dev`
التكوين: تأكد من أن وكيل vite يشير إلى خادم webman على المنفذ 8787
الفحص: تسجيل الدخول → لوحة التحكم → إدارة الحسابات → إنشاء خطة → تشغيل/إيقاف الخطة
...
### المهمة 9: تهيئة التوجيه والتحقق من تشغيل المشروع

**Files:**
- إنشاء: `service/start.php` (تعديل إن وُجد)
- Create: `README.md`

- [x] **الخطوة 1: إضافة تحميل الإضافات وتهيئة قاعدة البيانات في service/start.php**
...
- [x] **الخطوة 2: تشغيل هجرات قاعدة البيانات**
...
- [x] **الخطوة 3: تشغيل الخادم والتحقق من API**

التشغيل: `cd service && php start.php start -d`
...
```
المتوقع: `{"code":0,"data":{"access_token":"...","user":{...}}}`

اختبار المنصات:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
المتوقع: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **الخطوة 4: تشغيل لوحة الإدارة والتحقق من الربط المشترك**

التشغيل: `cd admin && npm run dev`

تدفق الاختبار:
1. افتح `http://localhost:5173` في المتصفح
2. سجّل الدخول بـ `admin / admin123`
3. عرض لوحة التحكم (بيانات فارغة)
4. الانتقال إلى إدارة الحسابات → ربط حساب (يتطلب AppId رسميًا من Juliang)
5. إنشاء خطة إعلانية اختبارية

- [x] **الخطوة 5: الالتزام بالحالة النهائية**
...
بعد اكتمال المرحلة 1 يجب الوصول إلى الحالة التالية:

1. ✅ يمكن تشغيل خادم webman v2، واتصال MySQL وRedis سليم
2. ✅ جدول المستأجرين المتعددين `tenants` منشأ، والوسيط TenantIdentify قابل للاستخدام
3. ✅ واجهة محول المنصات `PlatformAdapter` معرّفة بالكامل، ومحول Juliang ينفّذ جميع الطرق
4. ✅ تدفق تفويض OAuth مكتمل: الحصول على URL التفويض → معالجة الاستدعاء → تخزين Token → ربط الحساب
5. ✅ جداول الإطلاق الموحدة `campaigns/ad_groups/creatives` وجداول التقارير `report_metrics/report_extras` منشأة
6. ✅ يمكن الوصول إلى RESTful API بالمصادقة: `POST /auth/login` → الحصول على Token → استدعاء الواجهات الأخرى
7. ✅ يمكن تسجيل الدخول إلى لوحة الإدارة، وصفحات لوحة التحكم/إدارة الحسابات/إدارة الخطط قابلة للاستخدام
8. ✅ يمكن للوحة الإدارة إنشاء خطط إعلانية ومزامنتها إلى منصة Juliang
