# Phase 1: Kerangka Dasar Implementation Plan
...
**Tujuan:** Membangun kerangka server webman v2 + admin webman-admin v2, mengimplementasikan multi-tenancy, autentikasi & otorisasi, manajemen akun, dan kerangka alur OAuth, dengan Juliang (巨量引擎) sebagai platform pertama untuk memverifikasi seluruh rantai.

**Arsitektur:** Arsitektur plugin webman v2; di bawah `service/plugin/` dipecah menjadi empat plugin sesuai tanggung jawab: ads-tenant, ads-account, ads-platform, ads-api; admin menggunakan Vue3+TS+Element Plus, state dikelola dengan Pinia, Axios menghubungkan API backend.

**Tumpukan Teknologi:** PHP 8.2+, webman v2, MySQL 8.0, Redis 7, Vue 3, TypeScript, Element Plus, ECharts 5, Pinia, Axios
...
### Task 1: Inisialisasi Proyek Server webman v2
...
- [x] **Step 1: Membuat composer.json dan menginstal dependensi**
...
Jalankan: `cd service && composer install`

- [x] **Step 2: Membuat konfigurasi lingkungan .env**
...
- [x] **Step 3: Membuat config/app.php**
...
- [x] **Step 4: Membuat config/database.php dengan dukungan sumber data dinamis**
...
- [x] **Step 5: Membuat config/redis.php**
...
- [x] **Step 6: Membuat config/middleware.php**
...
- [x] **Step 7: Membuat support/Response.php untuk respons terpadu**
...
- [x] **Step 8: Membuat service/start.php**
...
- [x] **Step 9: Memverifikasi startup proyek**

Jalankan: `cd service && php start.php start`
Diharapkan: webman v2 berhasil dimulai, mendengarkan di port 8787
...
### Task 2: Membuat Plugin Multi-Tenant ads-tenant
...
- [x] **Step 2: Membuat router sumber data database.php**
...
- [x] **Step 4: Membuat middleware TenantIdentify**
...
### Task 3: Membuat Inti Adapter ads-platform
...
- [x] **Step 1: Membuat antarmuka PlatformAdapter**
...
- [x] **Step 3: Membuat ReportRequest**
...
- [x] **Step 4: Membuat mesin pemetaan field FieldMapping**
...
- [x] **Step 5: Membuat AdapterRegistry**
...
- [x] **Step 6: Membuat adapter Juliang (pemetaan field + kerangka antarmuka)**
...
- [x] **Step 8: Membuat SQL migrasi (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Step 9: Mendaftarkan adapter Juliang ke AdapterRegistry**

Buat `service/plugin/ads-platform/config/bootstrap.php`:
...
### Task 4: Membuat Plugin Manajemen Akun ads-account
...
- [x] **Step 2: Membuat model PlatformAccount**
...
- [x] **Step 3: Membuat model AuthToken (untuk penyimpanan state dalam alur OAuth)**
...
### Task 5: Membuat Plugin ads-api (RESTful API + Autentikasi JWT)
...
- [x] **Step 2: Membuat AuthMiddleware JWT**
...
- [x] **Step 3: Membuat AuthController**
...
- [x] **Step 4: Membuat PlatformController**
...
- [x] **Step 5: Membuat AccountController**
...
- [x] **Step 6: Membuat CampaignController**
...
- [x] **Step 7: Membuat DashboardController**
...
- [x] **Step 8: Membuat konfigurasi rute route.php**
...
### Task 6: Inisialisasi Proyek Admin webman-admin v2
...
- [x] **Step 2: Membuat vite.config.ts**
...
- [x] **Step 3: Membuat tsconfig.json**
...
- [x] **Step 7: Membuat src/router/index.ts**
...
- [x] **Step 8: Membuat src/api/index.ts (pembungkus Axios)**
...
- [x] **Step 9: Menginstal dependensi dan memverifikasi**

Jalankan: `cd admin && npm install && npm run dev`
Diharapkan: server pengembangan Vite berjalan di port 5173
...
### Task 7: Tata Letak Admin & Halaman Login
...
- [x] **Step 3: Membuat LoginPage.vue**
...
- [x] **Step 6: Membuat AppLayout.vue**
...
- [x] **Step 1: Membuat fungsi utilitas format.ts**
...
- [x] **Step 2: Membuat MetricCard.vue**
...
- [x] **Step 3: Membuat PlatformBadge.vue**
...
- [x] **Step 4: Membuat DashboardPage.vue**
...
- [x] **Step 5: Membuat AccountList.vue**
...
- [x] **Step 6: Membuat AccountBind.vue**
...
- [x] **Step 7: Membuat CampaignList.vue**
...
- [x] **Step 8: Membuat file pembungkus API**
...
- [x] **Step 9: Memverifikasi fungsionalitas admin**

Jalankan: `cd admin && npm run dev`
Konfigurasi: pastikan vite proxy mengarah ke server webman di port 8787
Periksa: Login → Dasbor → Manajemen Akun → Buat kampanye → Aktifkan/jeda kampanye
...
### Task 9: Panduan Konfigurasi & Verifikasi Startup Proyek

**Files:**
- Create: `service/start.php` (modifikasi jika ada)
- Create: `README.md`

- [x] **Step 1: Menambahkan pemuatan plugin dan inisialisasi database di service/start.php**
...
- [x] **Step 2: Menjalankan migrasi database**
...
- [x] **Step 3: Memulai server dan memverifikasi API**

Jalankan: `cd service && php start.php start -d`
...
```
Diharapkan: `{"code":0,"data":{"access_token":"...","user":{...}}}`

Uji platform:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
Diharapkan: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Step 4: Memulai admin dan memverifikasi integrasi**
...
3. Lihat dasbor (data kosong)
4. Masuk ke Manajemen Akun → Bind akun (membutuhkan AppId resmi Juliang)
5. Buat kampanye iklan uji

- [x] **Step 5: Komit status akhir**
...
Setelah Phase 1 selesai, status berikut harus tercapai:

1. ✅ Server webman v2 dapat dimulai, koneksi MySQL dan Redis normal
2. ✅ Tabel multi-tenant `tenants` dibuat, middleware TenantIdentify berfungsi
3. ✅ Antarmuka adapter platform `PlatformAdapter` terdefinisi lengkap, adapter Juliang mengimplementasikan semua metode
4. ✅ Alur otorisasi OAuth lengkap: ambil URL otorisasi → proses callback → simpan Token → bind akun
5. ✅ Tabel penayangan terpadu `campaigns/ad_groups/creatives` dan tabel laporan `report_metrics/report_extras` dibuat
6. ✅ RESTful API dapat diakses dengan autentikasi: `POST /auth/login` → dapatkan Token → panggil endpoint lain
7. ✅ Admin dapat login, halaman dasbor/manajemen akun/manajemen kampanye berfungsi
8. ✅ Admin dapat membuat kampanye iklan dan menyinkronkannya ke platform Juliang
