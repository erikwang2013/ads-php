# Phase 2: Ekspansi Platform Iklan + Mesin Laporan Implementation Plan
...
**Tujuan:** Menambahkan adapter Baidu Marketing dan Taobao Advertising, mengimplementasikan penjadwalan sinkronisasi data yang sesungguhnya, dan memperkuat mesin laporan untuk mendukung kueri multi-dimensi kustom.

**Arsitektur:** Setiap platform iklan mengimplementasikan antarmuka PlatformAdapter dan didaftarkan secara terpadu melalui AdapterRegistry. Sinkronisasi data menggunakan penjadwalan webman/crontab; selama sinkronisasi, data native platform dikonversi ke format terpadu melalui FieldMapping dan ditulis ke tabel report_metrics. Mesin laporan menambah kemampuan kueri kustom di CampaignController berdasarkan DashboardController yang ada.

**Tumpukan Teknologi:** PHP 8.2+, webman v2, webman/crontab, curl (panggilan API), Vue 3, ECharts 5

**Fondasi yang sudah ada dari Phase 1:**
- Antarmuka PlatformAdapter, AdapterRegistry, FieldMapping semuanya siap
- Adapter Juliang telah mengimplementasikan rantai lengkap (OAuth → Sinkronisasi → Operasi penayangan)
- Tabel report_metrics dibuat, DashboardController::summary() sudah memiliki kemampuan agregasi per tanggal/platform
- Tabel campaigns dibuat, CampaignController sudah memiliki CRUD lengkap
- Alur otorisasi umum OAuthService sudah siap

---

## Struktur File (baru/diubah di Phase 2)
...
### Task 10: Membuat Adapter Baidu Marketing

**Files:**
- Create: `service/plugin/ads-platform/adapter/Baidu.php`
- Modify: `service/plugin/ads-platform/config/bootstrap.php`

Inti koneksi API Baidu Marketing:
- Alamat otorisasi OAuth: `https://u.baidu.com/oauth/authorize`
- Pertukaran Token: `https://u.baidu.com/oauth/token`
- Kueri kampanye iklan: `/json/sms/service/CampaignService/getCampaign`
- Kueri laporan: `/json/sms/service/ReportService/getProfessionalReportId` + `getReportData`

#### Step 1: Membuat adapter Baidu.php
...
#### Step 2: Mendaftarkan adapter Baidu
...
### Task 11: Membuat Adapter Taobao Advertising

**Files:**
- Create: `service/plugin/ads-platform/adapter/Taobao.php`
- Modify: `service/plugin/ads-platform/config/bootstrap.php`

Inti koneksi API Taobao Advertising (Alimama):
- Otorisasi OAuth: platform terbuka Taobao OAuth 2.0
- Titik akhir API: `https://api.taobao.com/router/rest`
- Kampanye iklan: `alimama.campaign.get`
- Laporan: `alimama.report.get`

#### Step 1: Membuat Taobao.php
...
#### Step 2: Mendaftarkan adapter Taobao
...
### Task 12: Membuat Tugas Sinkronisasi Data + Penguatan Mesin Laporan
...
#### Step 1: Membuat plugin ads-task
...
#### Step 2: Membuat TokenRefreshTask
...
#### Step 4: Membuat konfigurasi tugas terjadwal cron.php
...
#### Step 5: Membuat plugin ads-report + ReportBuilder
...
#### Step 6: Membuat ReportController
...
#### Step 7: Menambah rute laporan

Tambahkan di grup autentikasi `route.php`:
```php
...
1. ✅ Adapter Baidu Marketing mengimplementasikan semua metode PlatformAdapter
2. ✅ Adapter Taobao Advertising mengimplementasikan semua metode PlatformAdapter (termasuk algoritma tanda tangan Taobao)
3. ✅ Penanganan callback OAuth didistribusikan secara terpadu melalui AdapterRegistry
4. ✅ Adapter Baidu/Taobao didaftarkan di bootstrap.php
5. ✅ TokenRefreshTask memindai Token yang kedaluwarsa dan menyegarkannya setiap 55 menit
6. ✅ DataSyncTask menarik data penayangan dan laporan setiap platform setiap 10 menit
7. ✅ API kueri laporan kustom mendukung multi-dimensi (platform/date/campaign) dan kombinasi multi-metrik
8. ✅ Data sinkron ditulis dengan benar ke tabel report_metrics
