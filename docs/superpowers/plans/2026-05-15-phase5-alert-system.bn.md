...
**Goal:** বিজ্ঞাপন ডেটা মনিটরিং অ্যালার্ট বাস্তবায়ন, কাস্টম রুল সাপোর্ট (খরচ সীমা ছাড়ানো/ROI খুব কম/কনভার্সন হঠাৎ কমে যাওয়া), একাধিক চ্যানেলের মাধ্যমে পুশ করা।

## Task 25: অ্যালার্ট ডেটা মডেল + রুল ইঞ্জিন
...
## Task 27: অ্যালার্ট শিডিউলিং + রিয়েল-টাইম পুশ
