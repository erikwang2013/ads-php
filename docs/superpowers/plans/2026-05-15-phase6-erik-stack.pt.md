...
|---|------|----|---------|
| 1 | Prefixo `erik_` das tabelas do banco | — | Todos os arquivos SQL/migração |
...
- Reescrever todos os arquivos de migração SQL (prefixo erik_ + bigint sem autoincremento)
