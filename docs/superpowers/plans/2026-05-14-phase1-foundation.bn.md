...
**Goal:** webman v2 সার্ভার + webman-admin v2 অ্যাডমিন প্যানেল স্কেলটন তৈরি করা, মাল্টি-টেন্যান্ট、অথেনটিকেশন পারমিশন、অ্যাকাউন্ট ম্যানেজমেন্ট、OAuth ফ্লো ফ্রেমওয়ার্ক বাস্তবায়ন করা, এবং প্রথম প্ল্যাটফর্ম হিসেবে 巨量引擎 (Juliang)-এর মাধ্যমে সম্পূর্ণ পাইপলাইন চালানো।

**Architecture:** webman v2 প্লাগইন-ভিত্তিক আর্কিটেকচার, service/plugin/-এর অধীনে দায়িত্ব অনুযায়ী ads-tenant、ads-account、ads-platform、ads-api চারটি প্লাগইন ভাগ করা হয়েছে; অ্যাডমিন প্যানেলে Vue3+TS+Element Plus ব্যবহৃত হয়, Pinia দিয়ে স্টেট ম্যানেজ করা হয়, Axios দিয়ে ব্যাকএন্ড API-তে সংযোগ করা হয়।
...
### Task 1: webman v2 সার্ভার প্রজেক্ট ইনিশিয়ালাইজ করুন
...
- [x] **Step 1: composer.json তৈরি করুন এবং ডিপেন্ডেন্সি ইনস্টল করুন**
...
- [x] **Step 2: .env এনভায়রনমেন্ট কনফিগ তৈরি করুন**
...
- [x] **Step 3: config/app.php তৈরি করুন**
...
- [x] **Step 4: config/database.php তৈরি করুন, ডায়নামিক ডেটা সোর্স সাপোর্ট**
...
- [x] **Step 5: config/redis.php তৈরি করুন**
...
- [x] **Step 6: config/middleware.php তৈরি করুন**
...
- [x] **Step 7: support/Response.php তৈরি করুন, ইউনিফাইড রেসপন্স**
...
- [x] **Step 8: service/start.php তৈরি করুন**
...
- [x] **Step 9: প্রজেক্ট স্টার্ট ভেরিফাই করুন**

Run: `cd service && php start.php start`
প্রত্যাশিত: webman v2 সফলভাবে চালু হয়েছে, 8787 পোর্ট লিসেন করছে
...
### Task 2: ads-tenant মাল্টি-টেন্যান্ট প্লাগইন তৈরি করুন
...
- [x] **Step 2: database.php ডেটা সোর্স রাউটিং তৈরি করুন**
...
- [x] **Step 3: Tenant মডেল তৈরি করুন**
...
- [x] **Step 4: TenantIdentify মিডলওয়্যার তৈরি করুন**
...
- [x] **Step 5: মাইগ্রেশন SQL তৈরি করুন**
...
### Task 3: ads-platform অ্যাডাপ্টার কোর তৈরি করুন
...
- [x] **Step 1: PlatformAdapter ইন্টারফেস তৈরি করুন**
...
- [x] **Step 2: CampaignData তৈরি করুন**
...
- [x] **Step 3: ReportRequest তৈরি করুন**
...
- [x] **Step 4: FieldMapping ফিল্ড ম্যাপিং ইঞ্জিন তৈরি করুন**
...
- [x] **Step 5: AdapterRegistry তৈরি করুন**
...
- [x] **Step 6: 巨量引擎 অ্যাডাপ্টার তৈরি করুন (ফিল্ড ম্যাপিং + ইন্টারফেস স্কেলটন)**
...
- [x] **Step 8: মাইগ্রেশন SQL তৈরি করুন (campaigns, ad_groups, creatives, report_metrics, report_extras)**
...
- [x] **Step 9: 巨量引擎 অ্যাডাপ্টার AdapterRegistry-তে রেজিস্টার করুন**
...
### Task 4: ads-account অ্যাকাউন্ট ম্যানেজমেন্ট প্লাগইন তৈরি করুন
...
- [x] **Step 2: PlatformAccount মডেল তৈরি করুন**
...
- [x] **Step 3: AuthToken মডেল তৈরি করুন (OAuth ফ্লোতে state স্টোরেজের জন্য)**
...
- [x] **Step 4: OAuthService তৈরি করুন**
...
### Task 5: ads-api প্লাগইন তৈরি করুন (RESTful API + JWT অথেনটিকেশন)
...
- [x] **Step 2: JWT AuthMiddleware তৈরি করুন**
...
- [x] **Step 3: AuthController তৈরি করুন**
...
- [x] **Step 4: PlatformController তৈরি করুন**
...
- [x] **Step 5: AccountController তৈরি করুন**
...
- [x] **Step 6: CampaignController তৈরি করুন**
...
- [x] **Step 7: DashboardController তৈরি করুন**
...
- [x] **Step 8: রুট কনফিগ route.php তৈরি করুন**
...
### Task 6: webman-admin v2 অ্যাডমিন প্যানেল প্রজেক্ট ইনিশিয়ালাইজ করুন
...
- [x] **Step 1: package.json তৈরি করুন**
...
- [x] **Step 2: vite.config.ts তৈরি করুন**
...
- [x] **Step 3: tsconfig.json তৈরি করুন**
...
- [x] **Step 5: src/main.ts তৈরি করুন**
...
- [x] **Step 6: src/App.vue তৈরি করুন**
...
- [x] **Step 7: src/router/index.ts তৈরি করুন**
...
- [x] **Step 8: src/api/index.ts তৈরি করুন (Axios এনক্যাপসুলেশন)**
...
- [x] **Step 9: ডিপেন্ডেন্সি ইনস্টল করুন এবং ভেরিফাই করুন**

Run: `cd admin && npm install && npm run dev`
প্রত্যাশিত: Vite ডেভেলপমেন্ট সার্ভার 5173 পোর্টে চালু হয়েছে
...
### Task 7: অ্যাডমিন প্যানেল লেআউট & লগইন পেজ
...
- [x] **Step 3: LoginPage.vue তৈরি করুন**
...
- [x] **Step 4: SideNav.vue তৈরি করুন**
...
- [x] **Step 6: AppLayout.vue তৈরি করুন**
...
### Task 8: অ্যাডমিন প্যানেল কোর পেজ
...
- [x] **Step 1: ইউটিলিটি ফাংশন format.ts তৈরি করুন**
...
- [x] **Step 2: MetricCard.vue তৈরি করুন**
...
- [x] **Step 3: PlatformBadge.vue তৈরি করুন**
...
- [x] **Step 4: DashboardPage.vue তৈরি করুন**
...
- [x] **Step 5: AccountList.vue তৈরি করুন**
...
- [x] **Step 6: AccountBind.vue তৈরি করুন**
...
- [x] **Step 7: CampaignList.vue তৈরি করুন**
...
- [x] **Step 8: API এনক্যাপসুলেশন ফাইল তৈরি করুন**
...
- [x] **Step 9: অ্যাডমিন প্যানেল ফাংশনালিটি ভেরিফাই করুন**

Run: `cd admin && npm run dev`
Config: vite proxy webman সার্ভার 8787 পোর্টের দিকে নির্দেশ করছে তা নিশ্চিত করুন
Check: লগইন → ড্যাশবোর্ড → অ্যাকাউন্ট ম্যানেজমেন্ট → প্ল্যান তৈরি → প্ল্যান চালু/বন্ধ
...
### Task 9: কনফিগ গাইড & প্রজেক্ট স্টার্টআপ ভেরিফিকেশন

**Files:**
- Create: `service/start.php` (আগে থেকে থাকলে পরিবর্তন করুন)
- Create: `README.md`

- [x] **Step 1: service/start.php-এ প্লাগইন লোডিং এবং ডাটাবেস ইনিশিয়ালাইজেশন যোগ করুন**
...
- [x] **Step 2: ডাটাবেস মাইগ্রেশন চালান**
...
- [x] **Step 3: সার্ভার চালু করুন এবং API ভেরিফাই করুন**
...
```
প্রত্যাশিত: `{"code":0,"data":{"access_token":"...","user":{...}}}`

প্ল্যাটফর্ম টেস্ট:
```bash
curl http://127.0.0.1:8787/api/v1/platforms
```
প্রত্যাশিত: `{"code":0,"data":[{"code":"juliang","name":"巨量引擎","capabilities":["report","campaign","creative","oauth"]}]}`

- [x] **Step 4: অ্যাডমিন প্যানেল চালু করুন এবং লিংক-আপ ভেরিফাই করুন**

Run: `cd admin && npm run dev`

টেস্ট ফ্লো:
1. ব্রাউজারে `http://localhost:5173` খুলুন
2. `admin / admin123` দিয়ে লগইন করুন
3. ড্যাশবোর্ড দেখুন (খালি ডেটা)
4. অ্যাকাউন্ট ম্যানেজমেন্টে যান → অ্যাকাউন্ট বাঁধুন (巨量引擎 আনুষ্ঠানিক AppId প্রয়োজন)
5. টেস্ট বিজ্ঞাপন প্ল্যান তৈরি করুন

- [x] **Step 5: চূড়ান্ত অবস্থা কমিট করুন**
...
Phase 1 শেষে নিম্নলিখিত অবস্থা অর্জন করতে হবে:

1. ✅ webman v2 সার্ভার চালু হতে পারবে, MySQL、Redis সংযোগ স্বাভাবিক
2. ✅ মাল্টি-টেন্যান্ট টেবিল `tenants` তৈরি হয়েছে, TenantIdentify মিডলওয়্যার ব্যবহারযোগ্য
3. ✅ প্ল্যাটফর্ম অ্যাডাপ্টার ইন্টারফেস `PlatformAdapter` সম্পূর্ণ সংজ্ঞায়িত, 巨量引擎 অ্যাডাপ্টার সব মেথড বাস্তবায়ন করেছে
4. ✅ OAuth অথরাইজেশন ফ্লো সম্পূর্ণ: অথরাইজেশন URL পাওয়া → কলব্যাক প্রসেসিং → Token স্টোরেজ → অ্যাকাউন্ট বাঁধা
5. ✅ ইউনিফাইড ডেলিভারি টেবিল `campaigns/ad_groups/creatives` এবং রিপোর্ট টেবিল `report_metrics/report_extras` তৈরি হয়েছে
6. ✅ RESTful API অথেনটিকেটেড অ্যাক্সেস: `POST /auth/login` → Token পাওয়া → অন্যান্য ইন্টারফেস কল
7. ✅ অ্যাডমিন প্যানেলে লগইন করা যায়, ড্যাশবোর্ড/অ্যাকাউন্ট ম্যানেজমেন্ট/প্ল্যান ম্যানেজমেন্ট পেজ ব্যবহারযোগ্য
8. ✅ অ্যাডমিন প্যানেলে বিজ্ঞাপন প্ল্যান তৈরি করে 巨量引擎 প্ল্যাটফর্মে সিঙ্ক করা যায়
