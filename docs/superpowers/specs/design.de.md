...
| RetrySyncTask | Alle 3 Minuten | Fehlgeschlagene Synchronisierungen wiederholen (ads_sync_errors-Tabelle, max. 3 Versuche, exponentielle Backoff) |
...
| Phase 10 | Chinesische Kommentare in Konfigurationsdateien + .env-Kommentare + Plattform-Credential-Dokumentation + ads_-Tabellenpräfix-Umschreibung + BIGINT-PK | ✅ |
