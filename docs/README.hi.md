...
<p align="center"><img src="docs/diagrams/svg/pet.svg" width="160" alt="प्रोजेक्ट शुभंकर 阿章"></p>

**阿章**（zhāng, «ऑक्टोपस»）इस प्रोजेक्ट का शुभंकर है: एक ऑक्टोपस। इसकी आठों भुजाएँ एक साथ जुटती हैं——हर भुजा अपना काम संभालती है और एक ही समय में 29 प्लेटफ़ॉर्मों तक पहुँचती है, यही काम यह प्रणाली करती है।

| रूप | अर्थ | संबंधित कार्यान्वयन |
|------|------|---------|
| आठ भुजाएँ | आठ प्लगइन, हर एक अपना काम संभालता है, सब समानांतर | ads-account / ads-alert / ads-api / ads-platform / ads-report / ads-storage / ads-task / ads-tenant |
| भुजाओं के सक्शन कप | डेटा रास्ते भर चिपककर एकत्र होता जाता है | 29 प्लेटफ़ॉर्म → एकीकृत `/api/v1` |
| दोनों आँखें सामने | एक साथ कई स्क्रीन पर नज़र | Vue Admin / Flutter / HarmonyOS तीनों एंड एक ही API साझा करते हैं |
| पलक झपकना + साँस | आवधिक पोलिंग और स्थिर पहरा | 6 निर्धारित कार्य (3/5/10/10/15/55 मिनट) चक्रीय संग्रह; 22 सुरक्षा उपाय मौन रूप से चलते हैं |
| बाहरी वलय के 29 नोड | 29 प्लेटफ़ॉर्म निरंतर ऑनलाइन | 16 घरेलू + 13 अंतर्राष्ट्रीय, हर एक पर नज़र |

阿章 कोड में एकीकृत है: एडमिन पैनल का **लॉगिन पेज** और **favicon**, Service एंड का **`/docs` API दस्तावेज़ पेज**, तथा सभी दस्तावेज़ पेज।

> SVG स्रोत [docs/diagrams/svg/pet.svg](docs/diagrams/svg/pet.svg)（पाठ रहित, 13 भाषाओं के दस्तावेज़ एक ही फ़ाइल साझा करते हैं; SMIL पलक और साँस एनिमेशन सहित）
...
- **प्रोजेक्ट शुभंकर** — ऑक्टोपस「阿章」, आठ भुजाएँ समानांतर, 29 प्लेटफ़ॉर्मों पर 24 घंटे तैनात（[pet.svg](docs/diagrams/svg/pet.svg)）
...
│   │   └── img/pet.svg                # प्रोजेक्ट शुभंकर「阿章」, /docs पेज पर प्रदर्शित
...
│   ├── public/web/
│   │   ├── public/pet.svg             # प्रोजेक्ट शुभंकर「阿章」, favicon + लॉगिन पेज
│   │   ├── src/
│   │   │   ├── views/                 # 21 Vue पेज
