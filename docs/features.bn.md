...
| 21 | CDN প্রদানকারী | CdnProviderController | 8 | CdnProviderList |

**মোট**: 21 মডিউল, 76 রাউট, 21টি Vue পেজ

![ফাংশনাল মডিউল ডায়াগ্রাম](diagrams/svg/functional-modules.bn.svg)
