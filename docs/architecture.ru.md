...
![Архитектура системы](diagrams/svg/architecture.ru.svg)
...
![Диаграмма потока запросов](diagrams/svg/request-flow.ru.svg)
...
![Схема архитектуры безопасности](diagrams/svg/security.ru.svg)
