...
![Systemarchitektur-Diagramm](diagrams/svg/architecture.de.svg)
...
![Anfrageablauf-Diagramm](diagrams/svg/request-flow.de.svg)
...
![Sicherheitsarchitektur-Diagramm](diagrams/svg/security.de.svg)
