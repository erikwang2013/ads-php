...
| 21 | CDN Providers | CdnProviderController | 8 | CdnProviderList |

**Total**: 21 modules, 76 routes, 21 Vue pages

![Functional Modules Diagram](diagrams/svg/functional-modules.en.svg)
