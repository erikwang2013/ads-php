...
![Diagrama de arquitetura do sistema](diagrams/svg/architecture.pt.svg)
...
![Diagrama de fluxo de requisições](diagrams/svg/request-flow.pt.svg)
...
![Diagrama de arquitetura de segurança](diagrams/svg/security.pt.svg)
