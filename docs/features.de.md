...
| 21 | CDN-Anbieter | CdnProviderController | 8 | CdnProviderList |

**Gesamt**: 21 Module, 76 Routen, 21 Vue-Seiten

![Funktionsmodul-Diagramm](diagrams/svg/functional-modules.de.svg)
