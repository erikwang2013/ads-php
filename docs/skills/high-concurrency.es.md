...
Implementa 8 estrategias de optimización de alta concurrencia.

## 1. Separación lectura/escritura de la base de datos
...
## 4. Caché de tres niveles

Consulta la [skill de estrategia de caché](cache-strategy.es.md)。
...
## 6. Limitación de tráfico multicapa en Nginx
