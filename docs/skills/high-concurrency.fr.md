# Optimisations haute concurrence
...
Mettre en œuvre 8 stratégies d'optimisation haute concurrence.

## 1. Séparation lecture/écriture de la base de données
...
## 4. Cache à trois niveaux

Voir la [compétence stratégie de cache](cache-strategy.fr.md).

## 5. File de messages asynchrone
...
## 6. Limitation multi-niveaux Nginx
