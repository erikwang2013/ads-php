...
Реализация 8 стратегий оптимизации для высокой нагрузки.

## 1. Разделение чтения и записи БД
...
См. [навык по стратегии кэширования](cache-strategy.ru.md)。

## 5. Асинхронная очередь сообщений
...
## 6. Многоуровневое лимитирование Nginx
