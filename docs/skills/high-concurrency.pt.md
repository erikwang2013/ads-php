...
Implementar 8 estratégias de otimização de alta concorrência.

## 1. Separação de leitura/escrita do banco de dados
...
## 4. Cache de três níveis

Consulte a [habilidade de estratégia de cache](cache-strategy.pt.md).

## 5. Fila de mensagens assíncrona
...
## 6. Limitação de taxa em várias camadas no Nginx
