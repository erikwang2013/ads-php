...
Terapkan 8 strategi optimasi high concurrency.

## 1. Pemisahan Baca-Tulis Database
...
## 4. Cache Tiga Tingkat

Lihat [skill Strategi Cache](cache-strategy.id.md)。

## 5. Antrean Pesan Asinkron
...
## 6. Rate Limit Multi-Lapisan Nginx
