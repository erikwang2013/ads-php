# Optimierung für hohe Nebenläufigkeit
...
8 Optimierungsstrategien für hohe Nebenläufigkeit umsetzen.

## 1. Datenbank-Lesen/Schreiben-Trennung
...
## 4. Dreistufiger Cache

Siehe [Cache-Strategie-Skill](cache-strategy.de.md).

## 5. Asynchronie über Message Queue
...
## 6. Nginx-Mehrschicht-Ratenbegrenzung
...
## 8. CDN für statische Ressourcen
