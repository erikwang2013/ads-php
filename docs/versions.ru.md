...
| Версионирование маршрутов (/api/v1) | ✅ | ✅ | ✅ |
...
| Библиотека материалов (index/upload/show/destroy/presign/register) | — | — | 6 |
| CDN-провайдеры (list/create/update/delete/default/toggle/test/purge) | — | — | 8 |
| **Итого** | **26** | **44** | **70** |
