...
تتوفر كل وثيقة في 12 إصدارًا لغويًا (`<name>.<lang>.md`)، والرسوم البيانية بصيغة `<name>.<lang>.svg`:

| اللغة | الكود | اللغة | الكود |
|------|------|------|------|
| الصينية | zh | Português | pt |
| الإنجليزية | en | हिन्दी | hi |
| الكورية | ko | العربية | ar |
| الروسية | ru | বাংলা | bn |
| الألمانية | de | Bahasa Indonesia | id |
| الفرنسية | fr | 日本語 | ja |
| الإسبانية | es | | |
